...
import ManImage from "../../static/man.png";
                                ...
                                <Grid item xs={3}>
                                  <TableContainer component={Paper}>
                                    <Table aria-label="customized table">
                                      <TableHead>
                                        <TableRow>
                                          <StyledTableCell>ETA to GTE</StyledTableCell>
                            ...
                            <ListItem divider sx={{ background: "#ccc" }}>
                              ...
                              <TableContainer>
                                ...
                                <Table sx={{ border: "1" }}>
                                  <TableHead>
                                    <TableRow>
                                      <TableCell>Case brief</TableCell>
                                ...
                                <Table sx={{ border: "1" }}>
                                  ...
                                  <TableBody>
                                      <StyledTableRow>
                                        ...
                                        <TableCell>{stumarks}</TableCell>
                                        <TableCell>
                                          {stusponserf}{stusponserm}{stusponsergf}
